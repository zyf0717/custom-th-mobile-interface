...
This document describes the device endpoints currently used or identified by teoheng-web-app.
...
These were identified in the stock UI but are not currently used by teoheng-web-app:
